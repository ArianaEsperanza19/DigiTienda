...
--
-- Host: 127.0.0.1    Database: digitienda
-- ------------------------------------------------------
...
CREATE TABLE `pedidos` (
  ...
  `coste` float(255,2) DEFAULT NULL,
  `fecha` date NOT NULL,
...
--
-- Dumping routines for database 'digitienda'
--
...
-- Dump completed on 2024-07-23 19:33:03
